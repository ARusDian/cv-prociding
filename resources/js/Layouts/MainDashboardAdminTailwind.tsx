      ...
      <div className="fixed top-0 left-0 h-screen flex justify-center w-64 bg-green-600 Z-0">
        <div className="mt-20 w-11/12 text-white">
          <ul className="flex flex-col gap-2 font-roboto">
            <Link href={route("dashboard.index")} className="px-5 py-2 rounded-xl hover:bg-[#FFA500]">Dashboard</Link>
            <Link href={route("proc.home")} className="px-5 py-2 rounded-xl hover:bg-[#FFA500]">Program Committe</Link>
            <Link href={route("pub.home")} className="px-5 py-2 rounded-xl hover:bg-[#FFA500]">Publication Opportunity</Link>
            <Link href={route("sci-rev.home")} className="px-5 py-2 rounded-xl hover:bg-[#FFA500]">Scientific Review</Link>
            <Link href={route("sub.home")} className="px-5 py-2 rounded-xl hover:bg-[#FFA500]">Submission Guideline</Link>
            {/* <Link href={route("pub.home")} className="px-5 py-2 rounded-xl bg-[#FFD27F] hover:bg-[#FFBB3F]">Users</Link> */}
            <hr className="border-1 border-black" />
            <Link href="/logout" method="POST" className="flex flex-row gap-2 px-4 py-3 rounded-xl hover:bg-[#FFBB3F] text-black">
