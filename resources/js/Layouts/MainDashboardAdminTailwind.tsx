...
const DashboardAdminTailwind = ({ children }: Props) => {
  ...
  return (
    <>
      ...
      <div>
        <div className="fixed top-0 left-0 flex flex-row items-center w-full bg-[#77B8A3] h-16 z-10 shadow-sm">
        ...
        <div className="fixed top-0 left-0 h-screen flex justify-center w-64 bg-[#77B8A3] Z-0">
