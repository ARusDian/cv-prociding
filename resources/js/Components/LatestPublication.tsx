  ...
  return (
    <>
      <div className="w-[50%] flex flex-col items-center gap-4">
        ...
        <a href={linkTo} target='_blank' className='bg-[#FFA500] px-4 py-2 text-lg font-black rounded-full hover:opacity-90 transition-all ease-out duration-300'>Access to Conference Paper Proceeding</a>
      </div>
    </>
  )
}
