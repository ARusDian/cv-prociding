    ...
    <MasterLayoutCSS active={active}>
      <div className="h-[800px] w-full flex flex-col justify-center items-center relative -z-100">
        ...
        <div className="flex flex-col justify-between items-center gap-2 lg:gap-4 -z-10 w-full">
          ...
          <h1 className="text-lg text-center font-bold">{header.date_stamp ? header.date_stamp : new Date().toLocaleDateString()}</h1>
          ...
          <h1 className="text-base xl:text-xl text-center font-bold w-[60%] break-words">{header.subtitle}</h1>
        </div>
      </div>
